function [ap_all,map]=TH14evalDet(detfilename,gtpath,subset,threshold)

%function [pr_all,ap_all,map]=TH14evalDet(detfilename,gtpath,subset,threshold)





% [pr_all,ap_all,map]=TH14evalDet(detfilename,gtpath,subset,[threshold])
%
